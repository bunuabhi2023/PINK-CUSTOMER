                    ...
                    >
                        {
                            ...
                            tiffineSubscription.filter((el) => el.lunch_or_dinner === "lunch").length > 0 &&
                            tiffineSubscription.filter((el) => el.lunch_or_dinner === "lunch").map((el) => {
