...
const SingleTiffinItemForTiffinHistory = ({
    id,
    home_chef_name,
    home_chef_id,
    tiffin_id,
    ...
    return (
        ...
        >
            <Box display="flex" justifyContent="space-between">
                ...
                {
                    endDate < currentDate && <Box display="flex" flexDir='column'>
                        <Text display='flex' fontSize={{ base: "80%" }} justifyContent="center" alignItems="center" fontWeight={500} bg={'red.100'} pl={2} pr={2} color="red" borderRadius="3px" textTransform={'capitalize'}>
                            {'Expired'}
                        </Text>
                    </Box>
                }
...
export { SingleTiffinItemForTiffinHistory };
